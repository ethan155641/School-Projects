...
using System.IO;
//using System.Drawing; // Commented as per instructions

public partial class Admin : System.Web.UI.Page
{
    // Global variable for upload path
    string uploadPath;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        checkTables(txtOwnerID.Text + "BOOKS", "CREATE TABLE " + txtOwnerID.Text + "BOOKS (Title CHAR(64), ISBN CHAR(14) UNIQUE, Author CHAR(64), Category CHAR(48), Image CHAR(128), Description CHAR(255))");
        initLstProgress();
    }
    ...
    protected void btnLoadImages_Click(object sender, EventArgs e)
    {
        ...
        if (!FileUpload1.HasFiles)
        {
            ...
            lstProgress.Items.Add("all images from the directory.");
            FileUpload1.Focus();
        }
        else
        {
    ...
    protected void btnLoadXML_Click(object sender, EventArgs e)
    {
        ...
        {
            lstProgress.Items.Add("Process XML Files.");
